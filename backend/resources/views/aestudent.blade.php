...
<div class="container">
    ...
    <form action="{{route('posteditstudent',['id' => $student->id])}}" method="POST">
        @csrf
        <div class="form-row">
            <label class="col-sm-2 col-form-label"  for="name">Name</label>
            <input type="text" class="form-control col-sm-10" name="name" value="{{$student->name}}"/>
        </div>
        <div class="form-row" style="margin-top: 10px;">
            <label class="col-sm-2 col-form-label"  for="birthday">Birthday</label>
            <input type="date" class="form-control col-sm-10" name="birthday" value="{{$student->birthday}}"/>
        </div>
        <?php $no=1?>
            @php
        ...
        <div class="form-row" style="margin-top: 10px;">
            ...
            <input type="number" name="points" min="0" max="10" step="1" value="{{$x}}">
        </div>
        <div class="form-row" style="margin-top: 10px;">
            <label class="col-sm-2 col-form-label"  for="music">Music</label>
            <input type="number" name="points" min="0" max="10" step="1" value="{{$y}}">
        </div>
        <div class="form-row" style="margin-top: 10px;">
            <label class="col-sm-2 col-form-label"  for="english">English</label>
            <input type="number" name="points" min="0" max="10" step="1" value="{{$z}}">
        </div>
