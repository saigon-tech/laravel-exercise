...
Route::get('/aestudent','Auth\StudentController@viewAddstudent')->middleware('auth')->name('addstudent');
Route::post('/aestudent','Auth\StudentController@addStudent');

Route::get('/editstudent/{id}','Auth\StudentController@showEditstudent')->middleware('auth')->name('editstudent');
Route::post('/editstudent/{id}','Auth\StudentController@editStudent')->name('posteditstudent');
